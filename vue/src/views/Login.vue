    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          ...
          {{ ' ' }}
          <a href="/register" class="font-medium text-fuchsia-900 hover:text-fuchsia-700"> Sign up here</a>
        </p>
      </div>
      <form class="mt-8 space-y-6" action="#" method="POST">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="#" class="font-medium text-fuchsia-900 hover:text-fuchsia-600"> Forgot your password? </a>
          </div>
        </div>
